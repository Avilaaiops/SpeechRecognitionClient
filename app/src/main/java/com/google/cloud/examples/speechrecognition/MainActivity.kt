...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mButton = findViewById(R.id.buttonoi)
        mButton2 = findViewById(R.id.buttonvey)

        mButton.setOnClickListener {
            mTextView.setText("Talk to me, Goose")
            StartListening()
        }

        mButton2.setOnClickListener {
            mTextView.setText("Click Start to Engage")
            StopListening()
        }
    }
